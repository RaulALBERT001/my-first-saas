"""
Django settings for M4N0 project.
...
# as soon as the project is in production, DEBUG will be set to false 
if DEBUG:
...
WSGI_APPLICATION = "M4N0.wsgi.application"
